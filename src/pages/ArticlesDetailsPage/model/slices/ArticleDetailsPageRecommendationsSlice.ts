...
import { fetchArticlesRecommendations } from '@/pages/ArticlesDetailsPage/model/services/fetchArticleRecommendations';
import {
    ArticlesDetailsRecommendationsScheme,
} from '../types/ArticlesDetailsRecommendationsScheme';
